export function LogoSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            id="e2ALfJdSy7v1"
...
export function InstallSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            <path d="M191 135c-9.375 9.375-9.375 24.56 0 33.94l80 80c9.375 9.375 24.56 9.375 33.94 0l80-80c9.375-9.375 9.375-24.56 0-33.94s-24.56-9.375-33.94 0L312 174.1V24C312 10.75 301.3 0 288 0S264 10.75 264 24v150.1L224.1 135C220.3 130.3 214.2 128 208 128S195.7 130.3 191 135zM528 0H352v64h160v224H64V64h160V0H48C21.5 0 0 21.5 0 48v320C0 394.5 21.5 416 48 416h192L224 464H152C138.8 464 128 474.8 128 488S138.8 512 152 512h272c13.25 0 24-10.75 24-24s-10.75-24-24-24H352L336 416h192c26.5 0 48-21.5 48-48v-320C576 21.5 554.5 0 528 0z" />
        </svg>
    );
}
export function MoonSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
...
export function SunSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
...
export function BarSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
...
export function OrientationSvg(rest: React.SVGProps<SVGSVGElement>) {
    const css = `.fa-secondary {opacity:.4}`;
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
            ...
            <path
                ...
                d="M0 112C0 85.49 21.49 64 48 64H320V224H48C21.49 224 0 202.5 0 176V112zM0 336C0 309.5 21.49 288 48 288H192V448H48C21.49 448 0 426.5 0 400V336z"
            />
            <path
...
export function CopySvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
            ...
            {...rest}
            viewBox="0 0 512 512">
            {/* Font Awesome 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */}
...
export function HistorySvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
...
export function EnvironmentSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
...
export function CorrectSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
...
export function DownloadSvg(rest: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="var(--general-text-color)"
