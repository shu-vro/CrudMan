...
var Splitter = /** @class */ (function (_super) {
    ...
    function Splitter(props) {
        ...
        _this.handleMouseMove = function (e) {
            ...
            var primaryPanePosition = Helpers_1.getPrimaryPaneWidth(
                position,
                clientX,
                clientY,
                maxMousePosition,
        ...
        _this.getSize = function (cX, cY) {
            ...
            * This function calculates the max position of a mouse in the current splitter from given percentage.
            ...
            var primaryPane = _this.panePrimary
                .getDivInstance()
                .getBoundingClientRect();
            var handleBarSize = _this.handlebar
                .getDivInstance()
                .getBoundingClientRect();
            var posInHandleBar =
                _this.props.position === "vertical"
            ...
            if (_this.props.position === "vertical") {
                ...
                var maxWidthStr = _this.props.primaryPaneMaxWidth
                    .match(regEx)[0]
                    .toLowerCase();
                var maxWidthNum = parseFloat(
                    _this.props.primaryPaneMaxWidth.split(regEx)[0]
                );
                ...
                var maxHeightStr = _this.props.primaryPaneMaxHeight
                    .match(regEx)[0]
                    .toLowerCase();
                var maxHeightNum = parseFloat(
                    _this.props.primaryPaneMaxHeight.split(regEx)[0]
                );
    ...
    Splitter.prototype.render = function () {
        ...
        return React.createElement(
            ...
            children[1]
                ? React.createElement(HandleBar_1.default, {
                      position: position,
